...
const fullWidthImages = [
  '/heal-scan/full-width1.jpg',
  '/heal-scan/full-width2.jpg',
  '/heal-scan/full-width3.jpg',
];

const featureImages = [
  {
    feature: 'High-Resolution Dental Scans',
    images: [
      '/heal-scan/feature1-1.jpg',
      '/heal-scan/feature1-2.jpg',
      '/heal-scan/feature1-3.jpg',
    ],
  },
  {
    feature: 'Real-Time Analysis and Reporting',
    images: [
      '/heal-scan/feature2-1.jpg',
      '/heal-scan/feature2-2.jpg',
      '/heal-scan/feature2-3.jpg',
    ],
  },
  {
    feature: 'Cloud Storage for Patient Data',
    images: [
      '/heal-scan/feature3-1.jpg',
      '/heal-scan/feature3-2.jpg',
      '/heal-scan/feature3-3.jpg',
    ],
  },
];

export default function HealScanMobile() {
      ...
      <div className="bg-blue-800 py-12">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Download the Heal Scan Mobile App
          </h2>
