...
const PrivacyPolicies = () => {
  return (
    <div className='max-w-4xl mx-auto px-4 py-8'>
      ...
      <p className="mb-4">Last updated: December 12, 2024</p>
      ...
      <p className="mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-blue-600 hover:text-blue-800">Privacy Policy Generator</a>.</p>
      ...
      <ul className="list-disc pl-6 mb-8">
        ...
        <li><strong>Application</strong> refers to Oral Scan, the software program provided by the Company.</li>
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Oral Scan.</li>
      ...
      <ul>
        <li>
          <p>By email: wenyaoxu@buffalo.edu</p>
        </li>
        <li>
          <p>By visiting this page on our website: <a href="https://dental-website-ub-esc.vercel.app/services/oralscan" rel="external nofollow noopener" target="_blank">https://dental-website-ub-esc.vercel.app/services/oralscan</a></p>
        </li>
        <li>
          <p>By phone number: (716)645-4748</p>
        </li>
      </ul>
    </div>
  );
